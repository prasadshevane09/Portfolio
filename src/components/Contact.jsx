...
const Contact = () => {
	...
	const handleSubmit = (e) => {
		...
		emailjs
			.send(
				...
				{
					from_name: username,
					to_name: "Prasad Shevane",
					reply_to: user_email,
					to_email: "shevaneprasad@gmail.com",
	...
	return (
        ...
        <div className='relative z-0 bg-black w-screen h-screen mt-12' >   
			<div className='text-white contact overflow-x-hidden pt-12 mt-8 ' id='contact' style={{backgroundColor:"black"}}>
				<div className='z-10 w-full sm:w-[650px] m-auto p-8 rounded-2xl' >
					...
					>
						...
						<button
							type='submit'
							className='pt-3 px-8 rounded-xl outline-none w-fit font-bold shadow-md bg-gray-900 text-center pb-3'
						>
